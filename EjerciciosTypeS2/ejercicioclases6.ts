let Nombres01: string[] = ["Andra" , "Aneu" , "Arlet","Ethud","Indivar","Samay","Sana","Tanit","Uxia","Zenda"];
let Nombres02: string[] = ["Abba","Acfred","Areu","Drac","Guim","lol","Kilian","Mirt","Yannick","Zigor","Tanit"];
console.log("Ejercicio1");
function imprimeNombre(value: any) {
    console.log(value);
}
...
function mayorDos(elemento:string) {
...
function palindromo(element: string) {
...
function mayorSeis(value: string) {
